...
.draw_end:
	...
	.box0msg1			db 'Welcome to CrepeOS!', 0
	...
	.t0l0				db ' Welcome to CrepeOS!', 13, 10
						db 10
						db ' CrepeOS is designed to be a quick, efficient and easy-to-use', 13, 10
	...
	.tsl0				db ' In CrepeOS, there also are some handy shortcuts, which can be', 13, 10
						db ' used by holding down the Alt key and pressing a function key:', 13, 10
						db 10
						db '  ', 1Ah, ' Alt + F2: Mute sounds', 13, 10
						db '  ', 1Ah, ' Alt + F3: Unmute sounds', 13, 10
						db '  ', 1Ah, ' Alt + F4: Quit the current application', 13, 10, 0
	...
	.t6l0				db 'CrepeOS Setup has finished.', 0
