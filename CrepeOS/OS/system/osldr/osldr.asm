...
OEMLabel		db "CROSBOOT"	; Disk label
...
VolumeLabel		db "CREPEOS    "; Volume Label: any 11 chars
...
; END OF BOOT SECTOR AND BUFFER START
    ...
    dw 0AA55h		; Boot signature (DO NOT CHANGE!!! THIS WILL RENDER CREPEOS UNBOOTABLE!!!)
